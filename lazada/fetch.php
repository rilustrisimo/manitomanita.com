...
$data = file_get_contents('/Users/eyorsogood/Sites/manitomanitav2/wp-content/themes/eyor-theme/lazada/assets/lazada.json');
...
function generateShopContents($products){
    ...
    foreach($products as $category){
        ...
        $filePath = '/Users/eyorsogood/Sites/manitomanitav2/wp-content/themes/eyor-theme/lazada/assets/categories/cat-'.strtolower(str_replace(" ", "-", $cat_name)).'.php';
